							...
							<VerticalTimeline>
								...
								>
									...
									<p className={classes.experienceContent}>
										Working for Cartier Joaillerie International, I developed several applications to improve the time management in workshops or gain a lot of time in the processes of logistics.
									</p>
									<p className={classes.experienceContent}>
										Using Devops methodology, I was also in charge of setting up a new technological stack at the IS pole 
									</p>
								...
								<VerticalTimelineElement
									...
									icon={<School />}
								>
									<h3 className="vertical-timeline-element-title">Specialty internship in Germany</h3>
									<h4 className="vertical-timeline-element-subtitle">BIM&amp;CO - KiM GmbH, Sankt-Wendel, Germany</h4>
									<p className={classes.experienceContent}>
										Development of two plugins for the CAD software Allplan® in the field of BIM objects (<i>Building Information Modeling</i>)
									</p>
									<p className={classes.technologies}>
										<Badge>C++</Badge>
										<Badge>MFC</Badge>
								...
								<VerticalTimelineElement
									...
									icon={<School />}
								>
									<h3 className="vertical-timeline-element-title">Project Manager (ISO 9001:2015 certified)</h3>
									<h4 className="vertical-timeline-element-subtitle">AEROW Solutions (with INSA Rouen-Normandie), Rouen, France</h4>
									<p className={classes.experienceContent}>
								...
								<VerticalTimelineElement
									...
									icon={<School />}
								>
									<h3 className="vertical-timeline-element-title">Specialization in Architecture of Information Systems</h3>
								...
								<VerticalTimelineElement
									...
									icon={<School />}
								>
									<h3 className="vertical-timeline-element-title">Preparatory cycle for engineering schools</h3>
									<h4 className="vertical-timeline-element-subtitle">INSA Rouen-Normandie, Rouen, France</h4>
								</VerticalTimelineElement>
								...
								<VerticalTimelineElement
									...
									icon={<Create />}
								>
									<h3 className="vertical-timeline-element-title">Scientific Baccalaureate — Baccalaureate with distinction</h3>
									<h4 className="vertical-timeline-element-subtitle">Lycée Saint-Joseph, Le Havre, France</h4>
									<p className={classes.experienceContent}>
